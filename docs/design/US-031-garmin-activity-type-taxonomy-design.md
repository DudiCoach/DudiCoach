...
# US-031 Design — Garmin Activity-Type Taxonomy for Athlete Sport Selector
...
3. Adds a **modality map** (`endurance | strength | skill | mixed`) keyed on
   root category, consumed by the AI prompt and US-030 activityType discovery.
...
| `water_sports` | mixed | `kayaking`, `rowing`, `stand_up_paddleboarding`, `sailing`, `surfing`, `windsurfing`, `kiteboarding`, `paddling`, `whitewater_rafting_kayaking`, `wakeboarding`, `snorkeling`, `diving` (single/multi-gas, gauge, apnea, ccr), `boating`, `fishing` |
...
sport: {
  // --- existing 11 ---
  pilka_nozna: "Piłka nożna", koszykowka: "Koszykówka", siatkowka: "Siatkówka",
  tenis: "Tenis", plywanie: "Pływanie", lekkoatletyka: "Lekkoatletyka",
  fitness: "Fitness", crossfit: "CrossFit", boks: "Boks", mma: "MMA", inne: "Inne",

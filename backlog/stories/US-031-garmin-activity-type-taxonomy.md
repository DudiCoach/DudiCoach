...
status: Draft
lane: C
dependencies: [US-002, US-012, US-030]
epic: EPIC-B
design_required: true
design_doc: docs/design/US-031-garmin-activity-type-taxonomy-design.md
adr_refs: []
created: 2026-08-22
updated: 2026-09-17
sprint: TBD
...
# US-031 — Garmin Activity-Type Taxonomy for Athlete Sport Selector
...
| `Sport` union typ (11 elementów) blokuje US-030 activityType discovery | Heurystyki endurance/strength/skill niemożliwe bez kategorii |
...
Wtedy sport wyświetla się jako "Piłka nożna" (label z mapy aliasów)
  ...
  I filtrowanie testów fitness działa jak przed US-031
...
Wtedy Beep Test jest widoczny na liście dostępnych testów
  I zachowanie jest identyczne jak dla sport: "lekkoatletyka" przed US-031
```
...
- Zmiana US-014 feedback na poziomie ćwiczenia (US-030 follow-up).

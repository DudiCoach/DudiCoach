...
# US-030 Design — Multi-part Activity Structure in Generated Training Plans
...
Plans generated before US-030 have exercises without `activityType`. The
...
Plans generated after US-030 always include `activityType`. The `"simple"` path

...
- **DudiCoach is NOT multi-cloud:** it uses Firebase (Hosting/Functions/Firestore) + Supabase (Postgres/RLS/Realtime/Auth). Use this skill only for infra-level architecture questions (e.g., Firebase vs Supabase boundaries, scaling, cost).
- **Related agents:** `.claude/agents/architect.md` (G2 for Lane C).

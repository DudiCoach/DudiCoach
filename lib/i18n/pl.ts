...
export const pl = {
  ...
  auth: {
    login: {
      ...
      loggingInWithGoogle: "Loguję przez Google...",
      or: "lub",
      backToAthletePanel: "Powrót do panelu zawodnika",
    },
    logout: {
      button: "Wyloguj",
  ...
  coach: {
    ...
    athlete: {
      ...
      diagnostics: {
        ...
        loading: "Ładowanie diagnostyki FMS...",
        empty: "Brak zarejestrowanych badań FMS.",
        emptyHint: "Kliknij \"Dodaj badanie\", aby dodać pierwszy wynik.",
        addButton: "Dodaj badanie",
        closeCreate: "Zamknij formularz",
        createTitle: "Nowe badanie FMS",
        createSubmit: "Dodaj badanie",
        creating: "Dodaję...",
        deleting: "Usuwam...",
        deleteConfirm: "Czy na pewno chcesz usunąć to badanie FMS?",
        errorGeneric: "Nie udało się zapisać diagnostyki FMS. Spróbuj ponownie.",
        field: {
          region: "Region",
          side: "Strona",
          muscle: "Mięsień",
      ...
      progressions: {
        sectionTitle: "Progresje",
        loading: "Ładowanie progresji...",
        empty: "Brak zapisanych progresji.",
        emptyHint: "Dodaj pierwszy wpis, aby rozpocząć śledzenie postępów.",
        ...
        deleteLast: "Usuń ostatni wpis",
        errorGeneric: "Nie udało się zapisać progresji. Spróbuj ponownie.",
        field: {
      ...
      summaries: {
        sectionTitle: "Podsumowania cykli",
        empty: "Brak podsumowań. Dodaj pierwsze podsumowanie po zakończeniu cyklu.",
        createTitle: "Nowe podsumowanie",
      },
      plans: {
        ...
        viewer: {
          ...
          athleteFeedback: "Informacja zwrotna zawodnika",
        },
      },
    },
  },
  ...
  athletePanel: {
    ...
    feedback: {
      yourFeedback: "Twoja informacja zwrotna",
      addFeedback: "Dodaj informację zwrotną dla tego dnia",
      edit: "Edytuj",
      save: "Zapisz",
      saving: "Zapisuję...",
      cancel: "Anuluj",
      placeholder: "Napisz jak poszło trening, co było trudne, co warto zmienić...",
      saved: "Informacja zwrotna zapisana",
    },
  },

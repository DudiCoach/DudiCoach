...
- **DudiCoach is TypeScript/Next.js** — this skill applies only to Python utility scripts (e.g., data migration scripts, local tooling). The main codebase is TS; prefer TS patterns from `lib/` and `components/`.
